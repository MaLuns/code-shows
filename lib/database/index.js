...
class DataBase {
    constructor(ctx) {
        ...
        this.CodeCache = new DataCache(); // 代码片段信息
        this.CodeAssetCache = new DataCache(); // 代码片段静态文件
    ...
    stringify () {
        const obj = {};
        ['FileCache', 'CodeCache', 'CodeAssetCache', 'AssetCache'].forEach(key => {
    ...
    save () {
        return writeFile(this.db_path, this.stringify());
    }
}
